...
function Cart() {
    ...
    function randomId(){
        return Math.floor(Math.random()*100000000)+Math.floor(Math.random()*100000000);
    }
        ...
        <div id={styles.container}>
                            ...
                            carts.map(item =>(
                                <div key={randomId()} id={styles.product}>
                                    <div id={styles.firstBox}>
                                        <Image alt="" priority src={'/products/'+item.imageURL} width={70} height={70}/>
            ...
            {!carts && (
                <div id={styles.noItems}>
                    <h1>You havent added any products yet</h1>
                    <p><a>want to add products?</a></p>
                </div>
            )}
        </div>
    )
